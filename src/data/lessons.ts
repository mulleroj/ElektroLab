...
export const lessons: MicroLesson[] = [
  ...
  },
  {
    ...
    explanation:
      '**Nadproud** je proud větší, než pro jaký je vedení nebo zařízení za daných podmínek určeno. Může vzniknout například přetížením nebo zkratem. Příliš velký proud může vodiče nebezpečně zahřívat. Silné zahřívání může poškodit izolaci nebo vést k požáru — nejde ale o automatický důsledek každého nadproudu.\n\n**Přetížení** nastane, když obvod zůstává zapojen obvyklým způsobem, ale odebírá větší proud, než pro jaký je navržen. Příčinou může být například příliš mnoho nebo příliš výkonných spotřebičů na jednom obvodu. Přetížení může způsobovat zahřívání. Nejde o přímé spojení vodičů s rozdílným potenciálem.\n\n**Zkrat** je nechtěné vodivé spojení mezi místy s rozdílným elektrickým potenciálem. Vznikne cesta s velmi malým odporem, takže při daném napětí může protékat velmi velký proud. Proud není doslova nekonečný a odpor při zkratu není vždy přesně nula — omezují ho zdroj, vodiče a další impedance obvodu. Zkrat může způsobit rychlé zahřívání, poškození nebo elektrický oblouk.\n\n**Rozdíl:** přetížení je příliš velký odběr v jinak obvyklém zapojení; zkrat vytváří nežádoucí cestu s velmi malým odporem. Přetížení nemusí být vždy pomalé a zkrat nemusí být vždy okamžitě odpojený — záleží na podmínkách.\n\n**Pojistka** obsahuje tavný prvek. Při nadproudu se zahřeje a přeruší obvod. Po vybavení se nenahrazuje drátem ani nepřemosťuje — nahrazuje se pouze správným typem a hodnotou.\n\n**Jistič** při nadproudu automaticky rozpojí obvod a může reagovat na přetížení i zkrat. Znovu se zapíná až po bezpečném odstranění příčiny; samotné zapnutí není oprava a opakované zapínání bez zjištění příčiny je nebezpečné.\n\n**Hranice ochrany:** pojistka a jistič chrání především vedení a zařízení před následky nadproudu, nikoli člověka před každým úrazem elektrickým proudem. Proudový chránič má jinou úlohu a není součástí této lekce; ani on ani jiné ochranné zařízení nezaručuje absolutní bezpečnost.',
    safetyNote:
